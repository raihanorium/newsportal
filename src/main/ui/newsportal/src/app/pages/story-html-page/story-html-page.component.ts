...
@Component({
    selector: 'app-story-html-page',
    templateUrl: './story-html-page.component.html',
    styleUrls: ['./story-html-page.component.css']
})
export class StoryHtmlPageComponent implements OnInit {
    id:number;
    private sub:any;
    private busy:any;
    private story:any;
